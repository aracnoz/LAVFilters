...
STDMETHODIMP CLAVSplitter::NonDelegatingQueryInterface(REFIID riid, void** ppv)
{
  ...
  *ppv = nullptr;
  ...
  return
    ...
    QI2(ILAVFSettingsDSPlayerCustom)
    QI(IObjectWithSite)
    QI(IBufferInfo)
...
// ILAVFSettingsDSPlayerCustom
STDMETHODIMP CLAVSplitter::SetPropertyPageCallback(HRESULT (*fpPropPageCallback)(IUnknown* pFilter))
{
